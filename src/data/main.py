...
def main():
    ...
    provinces = ["utrecht_east", "flevoland"]
    # provinces = ["flevoland"]
    n_files = None
    filter = 1
    year_start = 2008
    ...
    # DATA EXTRACTION
    # dataset = Dataset_Depth(province=provinces, max_files=n_files)
    # dataset = Dataset_Nitrate(province=provinces, max_files=n_files)
